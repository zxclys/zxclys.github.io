...
class ConfidentialNotSuppliedError(Error):
    """An API key and an API secret must be supplied."""
...
def main():
    ...
    parser.add_argument(
        "-ak", "--api_key", help="API key."
    )
    parser.add_argument(
        "-sk", "--api_secret", help="API secret."
    )
    parser.add_argument(
        "-d",
        "--dest",
    ...
    if not args.api_key or not args.api_secret:
        raise ConfidentialNotSuppliedError()
